          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">+961 81238678</p>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a href="https://github.com/OusamaAbouKhalil" className="p-3 bg-white/10 hover:bg-white/20 rounded-xl transition-all duration-300 hover:scale-110 hover:-rotate-12">
                  <Github className="w-6 h-6 text-gray-300 hover:text-white" />
                </a>
                <a href="https://www.linkedin.com/in/ousama-abou-khalil" className="p-3 bg-white/10 hover:bg-white/20 rounded-xl transition-all duration-300 hover:scale-110 hover:-rotate-12">
