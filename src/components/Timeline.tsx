  ...
  return (
    <section id="timeline" className="py-12 sm:py-20 px-4 sm:px-6 bg-gradient-to-b from-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-10 left-10 w-24 sm:w-32 sm:h-32 bg-cyan-500/5 rounded-full blur-xl sm:blur-2xl animate-float"></div>
        <div className="absolute bottom-20 right-20 w-32 sm:w-48 sm:h-48 bg-purple-500/5 rounded-full blur-xl sm:blur-2xl animate-float-delay-1"></div>
        <div className="absolute top-1/2 left-1/4 w-4 sm:w-6 sm:h-6 bg-lime-400/30 rotate-45 animate-float-delay-2"></div>
        <div className="absolute top-1/3 right-1/3 w-3 sm:w-4 sm:h-4 bg-cyan-400/30 rounded-full animate-float-delay-3"></div>
        <div className="absolute bottom-1/3 left-1/2 w-6 sm:w-8 sm:h-8 bg-purple-400/20 rotate-12 animate-float"></div>
        <div className="absolute top-1/5 left-1/5 w-5 sm:w-5 sm:h-5 bg-orange-400/25 rotate-45 animate-float-delay-1"></div>
        <div className="absolute bottom-1/5 right-1/5 w-5 sm:w-7 sm:h-7 bg-pink-400/30 rounded-full animate-float-delay-2"></div>
        <div className="absolute top-2/5 right-1/4 w-4 sm:w-6 sm:h-6 bg-emerald-400/25 rotate-12 animate-float-3d"></div>
      </div>
        ...
        {timeline.length === 0 ? (
          <div className="text-center py-20">
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 sm:p-12 border border-white/10 max-w-md mx-auto">
              <Briefcase className="w-12 sm:w-16 sm:h-16 text-gray-400 mx-auto mb-4" />
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timeline.map((item, index) => (
                ...
                >
                  {/* Timeline Node - Centered above card on small screens, centered on timeline on large screens */}
                  <div className="flex justify-center sm:absolute sm:left-1/2 sm:transform sm:-translate-x-1/2 z-20 mb-4 sm:mb-0">
                    <div
                      className={`w-12 sm:w-16 h-12 sm:h-16 rounded-full border-4 border-slate-900 flex items-center justify-center transform hover:scale-110 transition-all duration-300 ${
                        item.type === 'education'
                  ...
                  {/* Content Card - Full width on small screens, alternates left/right on large screens */}
                  <div
